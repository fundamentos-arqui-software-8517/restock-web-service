...
/**
 * Response resource representing a product with its availability calculated.
 *
 ...
 * @param maxAssemblable maximum units of this product that can be assembled
 */
@Schema(description = "Response resource representing a product with its maximum assemblable quantity based on stock")
public record ProductAvailabilityResource(
        ...
        @Schema(description = "Maximum units that can be assembled with current stock", example = "12")
        Integer maxAssemblable
) {}
